...
Input:
    ...
    **OGs csv file- two dimentional tab delimited file with OGs as rows and bacteria as columns. 
    ...
    example:
       --------------------------
       |   |bact1 |bact2 |bact3 |
       |OG1|ac_s_e|ac_s_e|ac_s_e|
       |OG2|ac_s_e|ac_s_e|ac_s_e|
       |OG3|ac_s_e|ac_s_e|ac_s_e|
       --------------------------
    **mcl dir - path to existing folder, under this folder a new folder named input_mcl and 
    output_mcl will be created.
Output:
...
def run_mcl(x):
    '''
    This function runs mcl, using an input mcl file and an output.
    '''
