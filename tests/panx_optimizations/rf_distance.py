...
def main():
    ...
    result2_df = compare_trees(original_orthogorups_inference_all_core_ogs_tree,
                               optimized_orthogorups_inference_1000_core_ogs_tree,
                               'original_all_core_ogs', 'optimized_1000_core_ogs')

    result3_df = compare_trees(original_orthogorups_inference_1000_core_ogs_tree,
                               optimized_orthogorups_inference_1000_core_ogs_tree,
                               'original_1000_core_ogs', 'optimized_1000_core_ogs')

    results_df = pd.concat([result1_df, result2_df, result3_df], ignore_index=True)
