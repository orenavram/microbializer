...
OG_TABLE_PATH_FOR_RESULTS_PAGE = INTERMEDIATE_OUTPUTS_DIRECTORY / 'tmp' / '07_2_orthogroups_visualizations' / 'orthogroups_results_page.csv'

PATHS_TO_DOWNLOAD = {
    "General": {
        "Inputs_(tar.gz)": (INPUTS_GENOMES_ZIPPED, "The input genomes in a tar.gz file"),
        "All_outputs_(tar.gz)": (ALL_OUTPUTS_ZIPPED, "All the outputs in a tar.gz file"),
    },
    "ANI (Average Nucleotide Identity)": {
        "ANI_table": (ANI_CSV, "Can also be found in 01_ani directory in the 'All outputs (tar.gz)' file"),
        "ANI_map": (ANI_MAP, "Can also be found in 01_ani directory in the 'All outputs (tar.gz)' file"),
    },
    "Genomes statistics": {
        "ORFs_count_per_genome": (ORFS_COUNT_PER_GENOME, "Can also be found in 02b_orfs_plots directory in the 'All outputs (tar.gz)' file"),
        "ORFs_count_histogram": (ORFS_COUNT_HISTOGRAM, "Can also be found in 02b_orfs_plots directory in the 'All outputs (tar.gz)' file"),
        "GC_content_per_genome": (GC_CONTENT_PER_GENOME, "Can also be found in 02b_orfs_plots directory in the 'All outputs (tar.gz)' file"),
        "GC_content_histogram": (GC_CONTENT_HISTOGRAM, "Can also be found in 02b_orfs_plots directory in the 'All outputs (tar.gz)' file"),
        "Genome_completeness_score_(BUSCO)_per_genome": (GENOME_COMPLETENESS_PER_GENOME, "Can also be found in 03_genomes_completeness directory in the 'All outputs (tar.gz)' file"),
        "Genome_completeness_score_(BUSCO)_histogram": (GENOME_COMPLETENESS_HISTOGRAM, "Can also be found in 03_genomes_completeness directory in the 'All outputs (tar.gz)' file"),
        "Orphan_genes_count_per_genome": (ORPHAN_GENES_PER_GENOME, "Can also be found in 04_orphan_genes directory in the 'All outputs (tar.gz)' file"),
        "Orphan_genes_count_histogram": (ORPHAN_GENES_HISTOGRAM, "Can also be found in 04_orphan_genes directory in the 'All outputs (tar.gz)' file"),
    },
    "Orthogroups": {
        "Orthogroups_(csv)": (OG_TABLE, "Can also be found in 05a_orthogroups directory in the 'All outputs (tar.gz)' file"),
        "Orthogroups_annotated_(csv)": (OG_TABLE_ANNOTATED, "Can also be found in 05a_orthogroups directory in the 'All outputs (tar.gz)' file"),
        "Orthogroups_(OrthoXML)": (OG_TABLE_ORTHOXML, "Can also be found in 05a_orthogroups directory in the 'All outputs (tar.gz)' file"),
        "Orthogroups_sizes_histogram": (OG_SIZE_HISTOGRAM, "Can also be found in 05b_orthogroups_visualizations directory in the 'All outputs (tar.gz)' file"),
        "Phyletic_pattern_(FASTA)": (PHYLETIC_PATTERN, "Can also be found in 05b_orthogroups_visualizations directory in the 'All outputs (tar.gz)' file"),
        "Phyletic_pattern_(png)": (PHYLETIC_PATTERN_PNG, "Can also be found in 05b_orthogroups_visualizations directory in the 'All outputs (tar.gz)' file"),
        "Genome_clusters_by_orthogroups_(csv)": (GENOME_CLUSTERS_CSV, "Can also be found in 05b_orthogroups_visualizations directory in the 'All outputs (tar.gz)' file"),
        "Genome_clusters_by_orthogroups_(png)": (GENOME_CLUSTERS_PNG, "Can also be found in 05b_orthogroups_visualizations directory in the 'All outputs (tar.gz)' file"),
        "Genomes_numeric_representation": (GENOME_NUMERIC_REPRESENTATION, "Can also be found in 05b_orthogroups_visualizations directory in the 'All outputs (tar.gz)' file"),
    },
    "Species tree": {
        "Species_tree_(newick)": (SPECIES_TREE_NEWICK, "Can also be found in 08_species_phylogeny directory in the 'All outputs (tar.gz)' file"),
        "Species_tree_(png)": (SPECIES_TREE_PNG, "Can also be found in 08_species_phylogeny directory in the 'All outputs (tar.gz)' file"),
    },
    "Codon bias analysis": {
        "Codon_adaptation_index_histogram": (CAI_HISTOGRAM, "Can also be found in 09_codon_bias directory in the 'All outputs (tar.gz)' file"),
        "W_vectors_(relative_adaptiveness)": (W_VECTORS, "Can also be found in 09_codon_bias directory in the 'All outputs (tar.gz)' file"),
        "Genome_clusters_by_relative_adaptiveness_(png)": (GENOMES_CLUSTERS_BY_W_VECTORS, "Can also be found in 09_codon_bias directory in the 'All outputs (tar.gz)' file"),
        "Genome_clusters_by_relative_adaptiveness_(csv)": (GENOMES_CLUSTERS_BY_W_VECTORS_CSV, "Can also be found in 09_codon_bias directory in the 'All outputs (tar.gz)' file"),
    }
}
