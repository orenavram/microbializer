...
ORFS_COUNT_PER_GENOME = f"{ALL_OUTPUTS_DIRECTORY}/02_2_orfs_plots/orfs_counts.json"
ORFS_COUNT_HISTOGRAM = f"{ALL_OUTPUTS_DIRECTORY}/02_2_orfs_plots/orfs_counts.png"
GC_CONTENT_PER_GENOME = f"{ALL_OUTPUTS_DIRECTORY}/02_2_orfs_plots/orfs_gc_content.json"
GC_CONTENT_HISTOGRAM = f"{ALL_OUTPUTS_DIRECTORY}/02_2_orfs_plots/orfs_gc_content.png"
...
OG_TABLE = f"{ALL_OUTPUTS_DIRECTORY}/05_1_orthogroups/orthogroups.csv"
OG_TABLE_ANNOTATED = f"{ALL_OUTPUTS_DIRECTORY}/05_1_orthogroups/orthogroups_annotated.csv"
OG_TABLE_ORTHOXML = f"{ALL_OUTPUTS_DIRECTORY}/05_1_orthogroups/orthogroups.orthoxml"
PHYLETIC_PATTERN = f"{ALL_OUTPUTS_DIRECTORY}/05_1_orthogroups/phyletic_pattern.fas"
OG_SIZE_HISTOGRAM = f"{ALL_OUTPUTS_DIRECTORY}/05_2_orthogroups_sizes/groups_sizes.png"

CORE_PROTEOME = f"{ALL_OUTPUTS_DIRECTORY}/07_1_aligned_core_proteome/aligned_core_proteome.fas"
CORE_GENOME = f"{ALL_OUTPUTS_DIRECTORY}/07_2_aligned_core_genome/aligned_core_genome.fas"
...
MICROBIALIZER_MAIN_JOB_MEMORY = '4096'
