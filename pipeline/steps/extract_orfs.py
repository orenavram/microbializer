...
def extract_orfs(logger, orfs_dir, orthogroups_file_path, start_og_number, end_og_number, output_dir, delimiter):
    ...
    with open(orthogroups_file_path) as f:
        ...
        strains = header_line.split(delimiter)[1:]
...
if __name__ == '__main__':
    ...
    try:
        extract_orfs(logger, args.orfs_dir, args.orthogroups_file_path, args.start_og_number,
                     args.end_og_number, args.output_dir, args.delimiter)
