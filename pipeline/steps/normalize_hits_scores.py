...
def normalize_hits_scores(logger, blast_result, output_path, scores_normalize_coefficient, use_only_csv):
...
if __name__ == '__main__':
    ...
    try:
        normalize_hits_scores(logger, args.blast_result, args.output_path,
                              float(args.scores_normalize_coefficient), args.use_only_csv)
