...
def extract_rbh_hits_of_pair(logger, m8_df, genome1, genome2, rbh_hits_dir, scores_statistics_dir,
                             max_rbh_score_per_gene_dir, temp_dir, debug):
    ...
    if debug:
        ...
        genome1_max_scores.to_parquet(output_genome1_max_scores, index_label='gene', header=['max_rbh_score'])
        genome2_max_scores.to_parquet(output_genome2_max_scores, index_label='gene', header=['max_rbh_score'])
...
if __name__ == '__main__':
    ...
    try:
        extract_rbh_hits(logger, args.m8_path, args.rbh_input_path, args.rbh_hits_dir,
                         args.scores_statistics_dir, args.max_rbh_score_per_gene_dir, args.debug)
