...
JOB_ARRAY_JOB_ID_ENVIRONMENT_VARIABLE = 'SLURM_ARRAY_JOB_ID'
JOB_ARRAY_TASK_ID_ENVIRONMENT_VARIABLE = 'SLURM_ARRAY_TASK_ID'

JOB_WALL_TIME_KEY = 'RunTime='
JOB_CPUS_KEY = 'NumCPUs='

JOB_DEFAULT_MEMORY_GB = 4
MMSEQS_BIG_DATASET_CPUS = 20
MMSEQS_BIG_DATASET_MEMORY_GB = 64
PHYLOGENY_CPUS = 20
PHYLOGENY_MEMORY_GB = 64
KEGG_CPUS = 20
KEGG_MEMORY_GB = 64
CODON_BIAS_CPUS = 20
CODON_BIAS_MEMORY_GB = 64
ANI_CPUS = 20
ANI_MEMORY_GB = 64
ORTHOXML_MEMORY_GB = 64
ORTHOGROUPS_VISUALIZATIONS_MEMORY_GB = 64
MERGE_SUB_ORTHOGROUPS_MEMORY_GB = 64
SORT_ORTHOGROUPS_MEMORY_GB = 64
PSEUDO_TABLE_ADD_ORPHANS_TO_OG_TABLE_MEMORY_GB = 64
...
MAX_NUMBER_OF_GENOMES_TO_ANALYZE = 2120
...
DEFAULT_CORE_MINIMAL_PERCENTAGE = 100.0

JOB_DONE_FILE_SUFFIX = '.done'
STEP_INPUTS_DIR_NAME = 'job_inputs'
