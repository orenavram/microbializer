...
python /groups/pupko/yairshimony/microbializer/pipeline/steps/normalize_hits_scores.py /groups/pupko/yairshimony/microbializer_runs/5_genomes/outputs/tmp/05_4_normalize_scores/jobs_inputs/6.txt /groups/pupko/yairshimony/microbializer_runs/5_genomes/outputs/steps_results/05_4_normalize_scores --use_parquet True -v False --logs_dir /groups/pupko/yairshimony/microbializer_runs/5_genomes/outputs/tmp/05_4_normalize_scores --error_file_path /groups/pupko/yairshimony/microbializer_runs/5_genomes/M1CR0B1AL1Z3R_outputs/error.txt --job_name 6_hits_normalize --use_job_manager True --cpus 1
touch /groups/pupko/yairshimony/microbializer_runs/5_genomes/outputs/tmp/05_4_normalize_scores/6_hits_normalize.done
